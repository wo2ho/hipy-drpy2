...
3. 本教程搭载 [sing-box 内核 reF1nd-Stable 版](https://github.com/reF1nd/sing-box/tree/reF1nd-stable)
...
```json
{
  ...
  "route": {
    ...
    "rule_set": [
      {
        "tag": [ "ads", "private", "applications", "microsoft-cn", "apple-cn", "google-cn", "games-cn", "games", "ai", "networktest", "proxy", "cn", "cnip", "telegramip" ],
        "type": "remote",
        "format": "binary",
